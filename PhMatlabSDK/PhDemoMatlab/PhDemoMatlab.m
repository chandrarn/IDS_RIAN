...
if (isa(GlobalObjects.hSelectedSource, 'Camera'))
    ...
    cameraIndex = GlobalObjects.hPoolRefresher.GetCameraIndexForSerial(hSelectedCamera.GetCameraSerial());
    if (cameraIndex>0)
...
if (isa(GlobalObjects.hSelectedSource, 'Camera'))
    ...
    if (hSelectedCamera.GetSupportsRecordingCines())
        ...
        for iCine = startCineNo:lastCineNo
            cineIds{cineIdsIndex} = Cine.GetStringForCineNo(iCine);
    ...
    for iCine = PhConConst.FIRST_FLASH_CINE:lastFlashCineNo
        cineIds{cineIdsIndex} = Cine.GetStringForCineNo(iCine);
        if (iCine == hSelectedCamera.SelectedCinePartNo)
            selectedIndex = cineIdsIndex;
        end
...
if (get(handles.popupmenuSources, 'Value')>0)
    ...
    if (strcmp(selectedSourceStr, 'File'))
        ...
        GlobalObjects.hSelectedSource = GlobalObjects.hPoolRefresher.GetCameraAt(GlobalObjects.hPoolRefresher.GetCameraIndexForSerial(serial));
        RefreshPartitionPopupmenu();
    end
...
if (isa(GlobalObjects.hSelectedSource, 'Camera'))
    hSelCam = GlobalObjects.hSelectedSource;
    hSelCam.SetSelectedCinePartNo(Cine.ParseCineNo(selectedCineStr));
    global gLastSelectedCineStatus;
...
set(handles.editFrameRate, 'String', num2str(acquisitionParams.FrameRate));
...
if (isa(hSelCam,'Camera') && ~hSelCam.IsCinePartitionStored(hSelCam.SelectedCinePartNo))
    ...
    acqParams.FrameRate = uint32(str2double(parText));
...
if (isa(GlobalObjects.hSelectedSource,'Camera'))
    ...
    if (cineToCapture == PhConConst.CINE_PREVIEW || cineToCapture>=PhConConst.FIRST_FLASH_CINE)
        if (hSelCam.HasStoredRAMPart() && ~ShowDeleteAllCinesMessage())
            return;
        end
...
function popupmenuSources_CreateFcn(hObject, eventdata, handles)
...
% --- Executes during object creation, after setting all properties.
function popupmenuCine_CreateFcn(hObject, eventdata, handles)
if ispc && isequal(get(hObject,'BackgroundColor'), get(0,'defaultUicontrolBackgroundColor'))
    set(hObject,'BackgroundColor','white');
end
end
...
% --- Executes during object creation, after setting all properties.
function editCrtFrame_CreateFcn(hObject, eventdata, handles)
if ispc && isequal(get(hObject,'BackgroundColor'), get(0,'defaultUicontrolBackgroundColor'))
    set(hObject,'BackgroundColor','white');
end
end
...
% --- Executes during object creation, after setting all properties.
function popupmenuPartitions_CreateFcn(hObject, eventdata, handles)
if ispc && isequal(get(hObject,'BackgroundColor'), get(0,'defaultUicontrolBackgroundColor'))
    set(hObject,'BackgroundColor','white');
end
end
...
% --- Executes during object creation, after setting all properties.
function editExposure_CreateFcn(hObject, eventdata, handles)
if ispc && isequal(get(hObject,'BackgroundColor'), get(0,'defaultUicontrolBackgroundColor'))
    set(hObject,'BackgroundColor','white');
end
end
...
% --- Executes during object creation, after setting all properties.
function editEDRExposure_CreateFcn(hObject, eventdata, handles)
if ispc && isequal(get(hObject,'BackgroundColor'), get(0,'defaultUicontrolBackgroundColor'))
    set(hObject,'BackgroundColor','white');
end
end
...
% --- Executes during object creation, after setting all properties.
function editImCount_CreateFcn(hObject, eventdata, handles)
if ispc && isequal(get(hObject,'BackgroundColor'), get(0,'defaultUicontrolBackgroundColor'))
    set(hObject,'BackgroundColor','white');
end
end
...
% --- Executes during object creation, after setting all properties.
function editPTFrames_CreateFcn(hObject, eventdata, handles)
if ispc && isequal(get(hObject,'BackgroundColor'), get(0,'defaultUicontrolBackgroundColor'))
    set(hObject,'BackgroundColor','white');
end
end
...
% --- Executes during object creation, after setting all properties.
function pushbuttonSet_CreateFcn(hObject, eventdata, handles)
end

% --- Executes during object creation, after setting all properties.
function popupmenuResolutions_CreateFcn(hObject, eventdata, handles)
if ispc && isequal(get(hObject,'BackgroundColor'), get(0,'defaultUicontrolBackgroundColor'))
    set(hObject,'BackgroundColor','white');
end
end
...
% --- Executes during object creation, after setting all properties.
function popupmenuBitDepth_CreateFcn(hObject, eventdata, handles)
if ispc && isequal(get(hObject,'BackgroundColor'), get(0,'defaultUicontrolBackgroundColor'))
    set(hObject,'BackgroundColor','white');
end
end
...
% --- Executes during object creation, after setting all properties.
function editWBRed_CreateFcn(hObject, eventdata, handles)
if ispc && isequal(get(hObject,'BackgroundColor'), get(0,'defaultUicontrolBackgroundColor'))
    set(hObject,'BackgroundColor','white');
end
end
...
% --- Executes during object creation, after setting all properties.
function editWBBlue_CreateFcn(hObject, eventdata, handles)
if ispc && isequal(get(hObject,'BackgroundColor'), get(0,'defaultUicontrolBackgroundColor'))
    set(hObject,'BackgroundColor','white');
end
end
