...
shot_a = 13061101; % real shot number with HIT-SI data to compare to (necessary
...
shot_b = 13061101; % real shot number with HIT-SI data to compare to (necessary
                 % even for NIMROD only to reference peaks).
...
screenChans = 0; % discard specific channels
...
%         xlim = [dat.peaks(7) dat.peaks(end-7)];
        xlim = [dat.peaks(1) dat.peaks(end)];
