...
plotFits = 0;
BDwing = param.yWing + 1; % number of points to either side of center in wavelength space to include in BD domain
...
data = zeros(n_time_o, n_pix_o, n_chan_o); % THIS SHOULD BE COMPATABLE WITH NEW CINE ARQUETECTURE
