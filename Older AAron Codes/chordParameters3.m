...
save5 = 0; % same as 'impacts2' except upper/long fiber order is reversed. 
           % This is because in summer 2014 the upper/lng fiber holder was
           % installed in mohawk port #6 upside down so that channel one
           % faced up instead of down.
...
alpha = 180 - 2*angles; % angle from one end of chord to axis to other end of chord
...
%% Configuration 5 - same as 2 but order reversed for upper/long fiber

impacts5 = impacts2;
impacts5(1:36) = impacts5(36:-1:1);
