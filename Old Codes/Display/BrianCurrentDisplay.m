...
[t.vxinj, dt.vxinj, sig.vxinj] = gen_data_in('\v_inj_x',HitTree);
[t.vyinj, dt.vyinj, sig.vyinj] = gen_data_in('\v_inj_y',HitTree);
[t.psixinj, dt.psixinj, sig.psixinj] = gen_data_in('\psi_inj_x',HitTree);
[t.psiyinj, dt.psiyinj, sig.psiyinj] = gen_data_in('\psi_inj_y',HitTree);
[t.ixinj, dt.ixinj, sig.ixinj] = gen_data_in('\i_inj_x',HitTree);
[t.iyinj, dt.iyinj, sig.iyinj] = gen_data_in('\i_inj_y',HitTree);
[t.itor, dt.itor, sig.itor] = gen_data_in('\i_tor_spaavg',HitTree);
