...
%   Press, et al., Numerical Recipes, Cambridge Univ. Press, 1992, Chapter
%   15.
...
example_number = 2;			  % which example to run.  
...
figure(3); % ------------ plot data, fit, and confidence interval of fit
 clf
 subplot(211)
%    plot(t,y_dat,'o', t,y_fit,'-', 'linewidth',2, t,y_fit+
%    1.96*sigma_y,'-r', t,y_fit-1.96*sigma_y,'-r');
   plot(t,y_dat,'o', t,y_fit,'-', t,y_fit+ 1.96*sigma_y,'-r', t,y_fit-1.96*sigma_y,'-r');
