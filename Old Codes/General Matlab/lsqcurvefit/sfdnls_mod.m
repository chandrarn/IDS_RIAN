function[J, ncol] = sfdnls_mod(xcurr,valx,Jstr,group,alpha,fun,YDATA,varargin)
%SFDNLS    Sparse Jacobian via finite differences
%
%
% J = sfdnls_mod(x,valx,J,group,[],fun) returns the
...
%
% J = sfdnls_mod(x,valx,J,group,fdata,fun,alpha) overrides the default
% finite differencing stepsize.
%
%[J, ncol] = sfdnls_mod(...) returns the number of function evaluations used
% in ncol.

%   Copyright 1990-2001 The MathWorks, Inc.
%   $Revision: 1.8 $  $Date: 2001/04/05 16:52:54 $
