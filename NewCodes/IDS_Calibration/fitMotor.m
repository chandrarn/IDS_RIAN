function [PIX_SP,parameters,data] = fitMotor(shot3, shot4, PEAKS, motorSpeed, brightWing, xWing, trimData,tOffset)
...
% tOffset offsets one of the movies [mv1,mv2]
plotFits = 0;

% Load Data
%PEAKS(2,:) = PEAKS(2,:)+1;
[data,time] = loadCalibMovies(shot3,shot4,tOffset,trimData);
